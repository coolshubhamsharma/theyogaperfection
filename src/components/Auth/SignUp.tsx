...
const SignUp = () => {
  return (
    <div className="card shadow-lg w-[35vw] bg-white">
          <h1 className=" mt-5 text-3xl font-bold ml-10 text-[#132c4cf7]">SignUp</h1>
          <form action="" className=" ml-10 mt-5">
            <fieldset className="fieldset">
              <legend className="fieldset-legend text-lg text-gray-800">Full Name </legend>
              <input type="text" className="input w-[28vw] rounded-lg" placeholder="Name" />
            </fieldset>
            ...
            <button className="h-[7vh] w-[28vw] shadow-lg mt-4 rounded-lg p-2 text-white bg-black text-lg hover:text-black hover:bg-white">Sign up</button>

            <hr className="h-[1px] w-[28vw] mt-5 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 border-0 my-4"></hr>
            

            <div className=" h-[8vh] w-[28vw] shadow-lg mt-4 rounded-lg p-2 bg-slate-100 flex justify-center gap-2 cursor-pointer">
